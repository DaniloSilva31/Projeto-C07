class ProPlayerDAO:
    ...
    def inserir(self, nickname, usuario_id, equipe_nome=None, titulos=None):
        try:
            sql = "INSERT INTO pro_player (nickname, usuario_id_usuario, equipe_nome, titulos) VALUES (%s, %s, %s, %s)"
            self.cursor.execute(sql, (nickname, usuario_id, equipe_nome, titulos))
            self.conn.commit()
